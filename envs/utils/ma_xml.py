...
def merge_multiagent_with_base(multiagent, args, ispath=True):
    base_xml = "../envs/assets/multi_ant.xml"
...
def create_multiagent_xml(xml_path, args):
    ...
    xml = merge_multiagent_with_base(x, args, False)
