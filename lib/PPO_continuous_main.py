...
def main(args, env_name, number, seed):
    ...
    # Build a tensorboard
    writer = SummaryWriter(log_dir='runs/env_{}_{}_number_{}_seed_{}'.format(env_name, args.policy_dist, number, seed))
...
if __name__ == '__main__':
    ...
    env_name = ['BipedalWalker-v4', 'HalfCheetah-v4', 'Hopper-v4', 'Walker2d-v4']
    env_index = 1
